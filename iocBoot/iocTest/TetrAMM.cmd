...
< $(QUADEM)/iocBoot/$(IOC)/commonPlugins.cmd
...
< $(QUADEM)/iocBoot/$(IOC)/saveRestore.cmd

iocInit()

# save settings every thirty seconds
#create_monitor_set("$(QUADEM)/iocBoot/$(IOC)/auto_settings.req",30,"P=$(PREFIX), R=$(RECORD):, R_TS=$(RECORD)_TS:")
